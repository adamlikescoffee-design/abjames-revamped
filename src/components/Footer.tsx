          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
            ...
            <div>
              ...
              <div className="flex gap-3 mb-6">
                <a aria-label="Adam James on Facebook" href="https://www.facebook.com/adamjameslikescoffee" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-foreground/10 flex items-center justify-center text-foreground/70 hover:text-primary hover:bg-foreground/20 transition-all"><Facebook size={18} /></a>
                <a aria-label="Adam James on Instagram" href="https://www.instagram.com/adam_likes_coffee" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-foreground/10 flex items-center justify-center text-foreground/70 hover:text-primary hover:bg-foreground/20 transition-all"><Instagram size={18} /></a>
                <a aria-label="Adam James on LinkedIn" href="https://www.linkedin.com/in/adam-likes-coffee/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-foreground/10 flex items-center justify-center text-foreground/70 hover:text-primary hover:bg-foreground/20 transition-all"><Linkedin size={18} /></a>
                <a aria-label="Adam James on Fireside Business Advice" href="https://www.firesidebusinessadvice.com/panellists/liberty-digital" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-foreground/10 flex items-center justify-center text-foreground/70 hover:text-primary hover:bg-foreground/20 transition-all"><Flame size={18} /></a>
                <a aria-label="Adam James on TikTok" href="https://www.tiktok.com/@adam_likes_coffee" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-foreground/10 flex items-center justify-center text-foreground/70 hover:text-primary hover:bg-foreground/20 transition-all"><TikTokIcon size={18} /></a>
              </div>
              <LanguageToggle />
            </div>
          </div>
